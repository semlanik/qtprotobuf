...
public:
    ...
    {
        std::cout << "testMethod called" << std::endl << request->testfieldstring() << std::endl;
    ...
    {
        std::cout << "testMethodServerStream called" << std::endl << request->testfieldstring() << std::endl;
        qtprotobufnamespace::tests::SimpleStringMessage msg;

        msg.set_testfieldstring(request->testfieldstring() + "1");
        std::this_thread::sleep_for(std::chrono::seconds(1));
        std::cout << "send back " << (request->testfieldstring() + "1") << std::endl;
        writer->Write(msg);

        msg.set_testfieldstring(request->testfieldstring() + "2");
        std::this_thread::sleep_for(std::chrono::seconds(1));
        std::cout << "send back " << (request->testfieldstring() + "2") << std::endl;
        writer->Write(msg);

        msg.set_testfieldstring(request->testfieldstring() + "3");
        std::this_thread::sleep_for(std::chrono::seconds(1));
        std::cout << "send back " << (request->testfieldstring() + "3") << std::endl;
        writer->Write(msg);

        msg.set_testfieldstring(request->testfieldstring() + "4");
        std::this_thread::sleep_for(std::chrono::seconds(1));
        std::cout << "send back " << (request->testfieldstring() + "4") << std::endl;
    ...
    {
        std::cout << "testMethodBlobServerStream called" << std::endl;
    ...
    {
        std::cout << "testMethodNonCompatibleArgRet called" << std::endl << request->testfield() << std::endl;
